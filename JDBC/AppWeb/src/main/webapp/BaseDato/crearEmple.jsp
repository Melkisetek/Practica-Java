...
<html>
    ...
    <body>
        <div class="container mt-5">
            <div class="row">
                <div class="col-sm">
                    <form action="crearEmple.jsp" method="post">
        ...
        <%
            if (request.getParameter("enviar") != null) {
                ...
                try {
                    ...
                    con = DriverManager.getConnection("jdbc:mysql://localhost/Dato?user=root&password=");
                    st = con.createStatement();
                    st.executeUpdate("insert into empledos(nombre,direccion,telefono) values('"+nombre+"','"+direccion+"','"+telefono+"');");
                    request.getRequestDispatcher("BaseMysql.jsp").forward(request, response);

                } catch (Exception e) { //try es importante para conectar en base dato
                    out.print(e);
                }
            }
        %>
